   ...
   <Nav>
    <div className={openMenu ? "menuIcon active" : "menuIcon"}>
        <ul className='navbar-list'>
            ...
            <li>
                <NavLink className= "navbar-link"  onClick={() => setOpenMenu(false)} to="/product">Product</NavLink>
            </li>
            <li>
            ...
            <li>
                <NavLink className= "navbar-link"  onClick={() => setOpenMenu(false)} to="/blog">Blob</NavLink>
            </li>
